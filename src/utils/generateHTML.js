...
<body>
  <div class="email-container">
    ...
    <div class="email-body">
      <h2>Hello ${name},</h2>
      <p>Thank you for signing up with Manoun. To complete your registration and start using your account, please click the button below to activate your account:</p>
